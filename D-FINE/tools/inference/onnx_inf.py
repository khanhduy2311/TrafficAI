...
def process_image(sess, im_pil):
    ...
    orig_size = torch.tensor([[resized_im_pil.size[1], resized_im_pil.size[0]]], dtype=torch.int32)
...
def process_video(sess, video_path):
    ...
    while cap.isOpened():
        ...
        orig_size = torch.tensor([[resized_frame_pil.size[1], resized_frame_pil.size[0]]], dtype=torch.int32)
